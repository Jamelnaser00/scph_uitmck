...
if (isset($_POST["submit"])) {
    ...
    $stmt->bind_param("sssss", $contact_name, $contact_studid, $contact_phone, $contact_email, $contact_desc);
...
<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #F6FF33;">
     Contact Us Form forUiTMCK Club Silat Cekak Pusaka Hanafi (SCPH)
   </nav>
