...
<head>
  ...
  <title>SCPH UiTMCK Club</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #F6FF33;">
    SCPH UiTMCK Club
  </nav>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00fffff;">
<h5>| <a href="index.php">Home </a>| <a href="home.php">Overview</a> | <a href="membership.php">Membership</a> | <a href="club.php">Club</a> | <a href="activity.php">Activities </a> | <a href="contact.php">Contact Us</a> | </h5></p>
</nav>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
    ...
    ?>
	<p align="center"><h3>Contact Us for UiTMCK Club UiTMCK Club Silat Cekak Pusaka Hanafi (SCPH)</h3></p>
